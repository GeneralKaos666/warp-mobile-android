...
# Anti-Knox-idle keep-awake: heartbeat every 20s defeats Samsung Knox Secure
# Folder's independent idle detector that re-triggers Bouncer regardless of
# screen_off_timeout / svc power stayon / FLAG_KEEP_SCREEN_ON. Setup overrides
# settings; cleanup restores them.
